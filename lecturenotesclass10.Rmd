...
There were 84 patients enrolled in the trial

- What is the probability a randomly selected patient received the placebo?
43/84 = 51.2% --> called marginal probability
...
- What is the probability a randomly selected patient received the placebo
  and the treatment?
0 ---> disjoint probability (impossible)
...
```
sample randomly draws one of the marbles, the size tells you how many "trials"
...
Pretty close, this reflects the "law of large numbers", that when you do a ton of draws, or increase the sample size, it will match closer to the proportion. 
...
roll_results
```
why dont we create a new dataset like we did for the marbles. Like why didnt we do 
dice<- c(1, 2, 3, 4, 5, 6) 
